...
| `googleMapsApiKey` | `string`                                                | ❌         | An official Google Maps API key. It's required to preview notifications of type `re.notifica.notification.Map`.                                                                                                                                                                                                                                                            |
| `locale`           | `string`                                                | ❌         | The language/region code for the UI (e.g., `en-GB`, `pt-PT`). <br/><br/>Default value: `en-GB`.                                                                                                                                                                                                                                                                            |
| `translations`     | `Partial<Record<NotificarePushTranslationKey, string>>` | ❌         | A set of custom translations to override the default ones.                                                                                                                                                                                                                                                                                                                 |
...
| `actions`     | `NotificareNotificationAction[]`     | ❌         | Interactive actions the user can realize (e.g., open link, answer, etc.) ([see structure](#NotificareNotificationAction)).                                                                                                                                                    |
