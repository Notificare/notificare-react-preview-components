...
Regardless of the preview component you're using, you can select which language to be used in the UI controls or even in the preview itself. Components will be automatically translated based on the chosen language, if available. Furthermore, you can also provide fully customizable translations, allowing you to personalize components to your liking. Check each component's documentation for more details on how to implement this.
