...
export default {
  title: 'ReactComponentLibrary/NotificationPreview',
  component: NotificationPreview,
} as Meta<typeof NotificationPreview>;

const Template: StoryFn<typeof NotificationPreview> = (args) => <NotificationPreview {...args} />;
