...
export const AndroidLockScreenPushWithMediaExpanded = Template.bind({});
AndroidLockScreenPushWithMediaExpanded.args = {
  notification: {
    type: 're.notifica.notification.Alert',
    title: 'Demo Notificare',
    subtitle: 'Subtitle',
...
export const AndroidLockScreenPushWithNoMediaExpanded = Template.bind({});
AndroidLockScreenPushWithNoMediaExpanded.args = {
  notification: {
    type: 're.notifica.notification.Alert',
    title: 'Demo Notificare',
    subtitle: 'Subtitle',
