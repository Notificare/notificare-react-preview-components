...
import {
  DIALOG_PUSH_ONBOARDING_APPLICATION_INFO_MOCK,
  FLOATING_BUTTON_BOTTOM_END_PUSH_ONBOARDING_APPLICATION_INFO_MOCK,
  FLOATING_BUTTON_BOTTOM_START_PUSH_ONBOARDING_APPLICATION_INFO_MOCK,
  FLOATING_BUTTON_TOP_END_PUSH_ONBOARDING_APPLICATION_INFO_MOCK,
  FLOATING_BUTTON_TOP_START_PUSH_ONBOARDING_APPLICATION_INFO_MOCK,
  INVALID_PUSH_ONBOARDING_APPLICATION_INFO_MOCK,
} from '~/components/NotificarePushOnboardingPreview/tests/mocks';
...
describe('NotificareOnboardingPreview', () => {
  ...
  test("when the launch configuration has 'autoOnboardingOptions', it renders a dialog as expected", () => {
    ...
    render(
      <NotificarePushOnboardingPreview
        applicationInfo={DIALOG_PUSH_ONBOARDING_APPLICATION_INFO_MOCK}
        serviceKey="123"
      />,
    );

    const dialogPreview = screen.getByTestId('push-onboarding-dialog-preview-wrapper');
    const dialogPreviewIcon = screen.getByTestId('push-onboarding-dialog-preview-icon');
    const dialogPreviewTitle = screen.getByTestId('push-onboarding-dialog-preview-title');
    const dialogPreviewMessage = screen.getByTestId('push-onboarding-dialog-preview-message');
    const dialogPreviewAcceptButton = screen.getByTestId('push-onboarding-dialog-accept-button');
    const dialogPreviewCancelButton = screen.getByTestId('push-onboarding-dialog-cancel-button');
  ...
  test("when the launch configuration has 'floatingButtonOptions' with bottom-end alignment configuration, it renders a floating button as expected", () => {
    ...
    render(
      <NotificarePushOnboardingPreview
        applicationInfo={FLOATING_BUTTON_BOTTOM_END_PUSH_ONBOARDING_APPLICATION_INFO_MOCK}
        serviceKey="123"
      />,
    );

    const floatingButtonPreview = screen.getByTestId('push-onboarding-floating-button-preview');

    // ASSERT
    expect(floatingButtonPreview).toBeInTheDocument();
    expect(floatingButtonPreview).toHaveClass(
      'notificare__push-onboarding__floating-button--end',
      'notificare__push-onboarding__floating-button--bottom',
    );
  });
  ...
  test("when the launch configuration has 'floatingButtonOptions' with bottom-start alignment configuration, it renders a floating button as expected", () => {
    ...
    render(
      <NotificarePushOnboardingPreview
        applicationInfo={FLOATING_BUTTON_BOTTOM_START_PUSH_ONBOARDING_APPLICATION_INFO_MOCK}
        serviceKey="123"
      />,
    );
    ...
    expect(floatingButtonPreview).toBeInTheDocument();
    expect(floatingButtonPreview).toHaveClass(
      'notificare__push-onboarding__floating-button--start',
      'notificare__push-onboarding__floating-button--bottom',
    );
  });
  ...
  test("when the launch configuration has 'floatingButtonOptions' with top-end alignment configuration, it renders a floating button as expected", () => {
    ...
    render(
      <NotificarePushOnboardingPreview
        applicationInfo={FLOATING_BUTTON_TOP_END_PUSH_ONBOARDING_APPLICATION_INFO_MOCK}
        serviceKey="123"
      />,
    );
    ...
    expect(floatingButtonPreview).toHaveClass(
      'notificare__push-onboarding__floating-button--end',
      'notificare__push-onboarding__floating-button--top',
    );
  });
  ...
  test("when the launch configuration has 'floatingButtonOptions' with top-start alignment configuration, it renders a floating button as expected", () => {
    ...
    render(
      <NotificarePushOnboardingPreview
        applicationInfo={FLOATING_BUTTON_TOP_START_PUSH_ONBOARDING_APPLICATION_INFO_MOCK}
        serviceKey="123"
      />,
    );
  ...
  test("when the launch configuration has 'floatingButtonOptions', 'permissionStatus' is 'default' and the user hovers the cursor over the button, it renders the floating button tooltip as expected", () => {
    ...
    const floatingButtonPreviewTooltip = screen.getByTestId(
      'push-onboarding-floating-button-preview-tooltip',
    );
  ...
  test('when the application info is invalid, it shows an error message as expected', () => {
    ...
    render(
      <NotificarePushOnboardingPreview
        applicationInfo={INVALID_PUSH_ONBOARDING_APPLICATION_INFO_MOCK}
        serviceKey="123"
      />,
    );
  ...
  test("when consumer provides locale 'fr', it loads fr messages", () => {
    ...
    // ASSERT
    expect(errorMessage).toHaveTextContent(
      PUSH_ONBOARDING_TRANSLATIONS_FR['preview.error.invalidPushOnboardingApplicationInfo'],
    );
  });
  ...
  test("when consumer provides locale 'pt', it loads pt messages", () => {
    ...
    // ASSERT
    expect(errorMessage).toHaveTextContent(
      PUSH_ONBOARDING_TRANSLATIONS_PT['preview.error.invalidPushOnboardingApplicationInfo'],
    );
  });
  ...
  test('when custom translations are provided, it uses them as expected', () => {
    ...
    render(
      <NotificarePushOnboardingPreview
        applicationInfo={INVALID_PUSH_ONBOARDING_APPLICATION_INFO_MOCK}
        translations={{ 'preview.error.invalidPushOnboardingApplicationInfo': 'Custom' }}
        serviceKey="123"
      />,
    );
