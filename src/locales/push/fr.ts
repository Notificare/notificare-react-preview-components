...
export const PUSH_TRANSLATIONS_FR: Record<NotificarePushTranslationKey, string> = {
  ...
  'preview.error.notSupportedUrlResolverWithUrlSchemePreview':
    "→ L’aperçu des notifications de type 're.notifica.notification.URLResolver' avec un schéma d’URL personnalisé (URL Scheme) n’est pas possible",
  ...
  'preview.error.notSupportedUrlResolverWithDynamicLink':
    "→ L’aperçu des notifications de type 're.notifica.notification.URLResolver' avec un lien dynamique n’est pas possible",
  'preview.error.notSupportedUrlResolverWithRelativeUrl':
    "→ L’aperçu des notifications de type 're.notifica.notification.URLResolver' avec une URL relative (commençant par '/') n’est pas possible",
